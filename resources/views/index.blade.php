...
<head>
  ...
  <title>Proyecto Investiga | UCSG</title>
...
<body class="hold-transition login-pge" >
<div class="login-box">
  ...
  <div class="login-box-body">
    <div class="panel-heading">
        <p class="login-box-msg">Proyecto de investigación científica</p>
    </div>
   ...
   <form action="auth/store" method="post">
      ...
      <div class="row">
        ...
        <div class="col-xs-4">
          ...
          <!--<a href="{{ url('menu') }}" class="btn btn-success pull-leff">Ingresar</a>-->
        </div>
        <!-- /.col -->
      </div>
    </form>
    ...
    <br>
    <a href="auth/register">Registrar nuevo usuario</a><br>
